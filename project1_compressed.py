...
def display_main_screen():
    ...
    print("\n\n")
    cprint(" EXPERIMENT 1: COVER IMAGE SELECTION AMONG COMPRESSED PNG IMAGES ".center(os.get_terminal_size().columns), 'green')
    print("\n\n")
...
def main():
    ...
    # Example usage:
    image_paths = ["image9_compressed.png", "image10_compressed.png", "image11_compressed.png", "image12_compressed.png", "image13_compressed.png", "image14_compressed.png", "image15_compressed.png", "image16_compressed.png"]
    ...
    print("\n")
    cprint(f'Selected Cover Image from 8 Compressed PNG Images is : {highest_cumulative_image_name}','green')
    print("\n")
    ...
    plt.title(f'\nSelected Cover Image : {highest_cumulative_image_name}\n',fontname='fantasy',fontsize=30)
    plt.axis('off')
    plt.show()
    cprint(f'\n Now, executing the Next Process: Selection of Cover Image from Uncompressed PNG Images','red')
    print("\n")
    input("")
    subprocess.run(["python", "project1_uncompressed.py"])
